:project-name: miq-BlueCat
:project-repo: https://github.com/rhtconsulting/miq-BlueCat
:project-zip: https://github.com/rhtconsulting/miq-BlueCat/archive/master.zip
